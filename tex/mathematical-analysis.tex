...
In Darboux's formulation, the integral exists if and only if the upper and lower integrals are equal to each other. We now show that this is equivalent to the criterion of the existence of integrals from our definition (Definition~\ref{def:1}). Furthermore, we will introduce another equivalent condition, \textbf{Riemann's criterion}\index{Riemann's criterion}, which is convenient to use in proofs.

\begin{definition}[Riemann's Criterion]
...
\begin{theorem}[Second Mean Value Theorem] \label{thm:78}
...
The \textbf{first fundamental theorem of calculus}\index{first fundamental theorem of calculus}
...
\begin{theorem}[First Fundamental Theorem of Calculus] \label{thm:81}
...
The \textbf{second fundamental theorem of calculus}\index{second fundamental theorem of calculus}
mainly tells us how to integrate a derivative.

\begin{theorem}[Second Fundamental Theorem of Calculus] \label{thm:82}
...
\begin{theorem}[Change of Variables] \label{thm:83}
...
\begin{definition} \label{def:6}
	...
	or a \textbf{zero-measure}\index{zero-measure sets} set 
...
\begin{definition} \label{def:7}
	...
	\end{align*}
	is called the \textbf{oscillation of $f$ on $S$}\index{oscillation of a function on a set}.
\end{definition}
...
We can also define the \textbf{oscillation of $f$ at a point $x$}\index{oscillation of a function at a point}.
...
\begin{theorem}[Lebesgue's Number Lemma] \label{thm:88}
	% TODO
\end{theorem}
...
\begin{theorem}[Lebesgue's Criterion for Reimann-Integrability] \label{thm:89} 
...
\begin{definition} \label{def:10}
	...
	on $[ a, \infty )$,
	and the \textbf{improper Riemann integral}\index{improper Riemann integral of the first kind},
	...
	The \textbf{second kind}\index{improper Riemann integral of the second kind} improper integrals 
	are those whose
...
\begin{definition} \label{def:11}
	The \textbf{arcsine}\index{arcsine} function,
	written as $\arcsin x$,
	is defined by
	\begin{align}
		\arcsin x
