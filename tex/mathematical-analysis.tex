...
\begin{theorem} \label{thm:51}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            \abs{\sum_{k=1}^n a_k} \leq A
            \quad \forall n \in \N^\ast
        \end{align*}
        for some positive constant $A$, and
        \item even more generally, all finite sums of consecutive terms are bounded by a common constant, that is, there exists $A > 0$ such that 
        \begin{align*}
            \abs{\sum_{k=m}^n a_k} \leq A
...
\begin{proof}
    ...
    \begin{align}
        ...
        < \frac{\varepsilon / 2}{\abs{B} + \varepsilon}
        \quad
        \forall m \geq N_1 \; 
        \forall j \in \N
        \label{eq:110}
