...
\begin{exercise} \label{ex:10}
	Provide a simpler proof of Theorem~\ref{thm:87}
...
\begin{theorem}[Lebesgue's Criterion for Reimann-Integrability] \label{thm:91}
...
\begin{proof}
	...
	Then there exists an positive number $\varepsilon_0 > 0$
	...
	\begin{align*}
		D_r \setminus P \subseteq \bigcup (x_{k-1}, x_k)
	\end{align*}
