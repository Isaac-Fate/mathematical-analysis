...
\begin{example} \label{eg:4}
	...
	The graph of the function $\sin^2(x) \cos(x)$ is shown in Figure~\ref{fig:11}.
	\begin{figure}[H]
		\centering
...
\begin{exercise}
	Simplify the integral $I(x)$ in Example~\ref{eg:4} in a different way
	by applying \eqref{eq:60} in the forward direction.
\end{exercise}
